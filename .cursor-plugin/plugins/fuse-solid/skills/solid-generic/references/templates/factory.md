...
description: Factory pattern template with dependency injection and the shared source-size ceiling
...
- Keep each factory within `FUSE_SOLID_MAX_LINES` (default 200) and focused on one responsibility
