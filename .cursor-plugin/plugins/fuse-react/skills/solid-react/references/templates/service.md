...
applies-to: "**/*.tsx, **/*.jsx"
description: Service template with dependency injection using the shared source-size ceiling
---
...
- Keep each service within `FUSE_SOLID_MAX_LINES` (default 200) and focused on one responsibility
