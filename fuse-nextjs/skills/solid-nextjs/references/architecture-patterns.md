...
- Contains ONLY what is genuinely shared across features
...
1. **Genuinely shared across multiple features** (not before!)
...
- [ ] Pages stay within `FUSE_SOLID_MAX_LINES` (default 200) and delegate to modules
