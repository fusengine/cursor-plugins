...
| **ISP** | Small, focused interfaces | Members serve one client role |
...
- Source files stay within `FUSE_SOLID_MAX_LINES` (default 200) and are split by responsibility when cohesion drops
...
Split interfaces that mix client roles into focused ones.
