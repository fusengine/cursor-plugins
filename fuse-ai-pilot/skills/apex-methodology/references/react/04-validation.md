...
if [ ! -f ".cursor/apex/docs/elicit-${TASK_SLUG}.json" ]; then
  echo "❌ Missing .cursor/apex/docs/elicit-${TASK_SLUG}.json — go back to references/react/03.5-elicit.md first."
  exit 1
fi
...
[ ] Props destructured
[ ] JSDoc present
[ ] Focused presentation responsibility
