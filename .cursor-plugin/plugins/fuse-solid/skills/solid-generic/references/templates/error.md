---
name: error-template
description: Custom error class template using the shared source-size ceiling
...
- Keep each error file within `FUSE_SOLID_MAX_LINES` (default 200) and focused on one responsibility
