...
3. **Run** `npx -y @fusengine/harness scan <dir>` for automated scanning (OWASP patterns ported into the harness). This standalone CLI verb does not depend on Cursor hook normalization.
