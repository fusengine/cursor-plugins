...
when-to-use: When reading, writing, or managing ai-pilot cache files in .harness/cache/
...
| File | Content |
|------|---------|
| `.harness/cache/lessons.json` | Learned patterns and corrections |
| `.harness/cache/docs.json` | Documentation lookups |
| `.harness/cache/tests.json` | Test results and coverage |
| `.harness/cache/explore.json` | Codebase exploration results |
