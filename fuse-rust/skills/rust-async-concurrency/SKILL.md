...
1. **fuse-ai-pilot:explore-codebase** — find the existing runtime, channel, and lock patterns already in use
2. **fuse-ai-pilot:research-expert** — verify current tokio/crate APIs via Context7/Exa (async APIs churn)
