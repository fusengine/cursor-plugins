...
description: Client hook wrapping a Start server function via useServerFn / TanStack Query using the shared source-size ceiling
---
...
- Keep the hook within `FUSE_SOLID_MAX_LINES` (default 200) and focused on one responsibility.
