...
- `mcp__fuse-browser__browser_scroll`
- `mcp__fuse-browser__browser_wait_for`
- `mcp__fuse-browser__browser_snapshot`
- `mcp__fuse-browser__browser_screenshot`
- `mcp__fuse-browser__browser_click`
...
- `mcp__fuse-browser__browser_extract_schema`
...
enforces something not proven in the current Cursor runtime — hooks here are intended to provide state tracking, not guaranteed phase gating; actual Cursor state tracking remains runtime-unverified.
