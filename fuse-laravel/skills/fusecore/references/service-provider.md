...
### 1. Keep Providers Cohesive

- Source files must not exceed `FUSE_SOLID_MAX_LINES` (default 200).
- Keep each provider focused on registration and bootstrapping for one cohesive concern.
- Extract runtime business logic to services.
