---
description: "APEX workflow shadcn/ui expert - 8 phases mandatory: load skills, detect primitive (Radix UI vs Base UI), analyze components, plan cohesive and reviewable tasks, consult MCP (shadcn + Context7), implement with correct API, self-review via elicitation, sniper validation. NEVER skip detection. NEVER mix Radix/Base UI."
...
| **P** | 03-plan-changes | TaskCreate + cohesive, reviewable file planning |
