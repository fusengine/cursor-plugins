...
## SOLID Rules
**Read `solid-nextjs` skill before ANY code.** Source files must stay within `FUSE_SOLID_MAX_LINES` (default 200), interfaces belong in `modules/[feature]/src/interfaces/`, and JSDoc is mandatory.
