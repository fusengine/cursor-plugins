---
name: solid-generic
description: "Use when building CLI tools, libraries, scripts, hooks, or non-framework TypeScript code (Bun/Node.js -- SOLID, FUSE_SOLID_MAX_LINES source-size ceiling, JSDoc mandatory)."
version: 1.0.0
user-invocable: true
...
4. If code is genuinely shared across modules -> create it in `modules/cores/`
...
- Source files must not exceed `FUSE_SOLID_MAX_LINES` (default 200).
- Split modules, services, and validators by responsibility when cohesion drops.
...
|----------|-------|------------------|
| [module.md](references/templates/module.md) | TypeScript/Bun module | `FUSE_SOLID_MAX_LINES` (default 200) |
| [service.md](references/templates/service.md) | Service with DI | `FUSE_SOLID_MAX_LINES` (default 200) |
| [interface.md](references/templates/interface.md) | TypeScript interfaces | `FUSE_SOLID_MAX_LINES` (default 200) |
| [validator.md](references/templates/validator.md) | Zod validation schemas | `FUSE_SOLID_MAX_LINES` (default 200) |
| [factory.md](references/templates/factory.md) | Factory pattern | `FUSE_SOLID_MAX_LINES` (default 200) |
| [error.md](references/templates/error.md) | Custom error classes | `FUSE_SOLID_MAX_LINES` (default 200) |
| [test.md](references/templates/test.md) | Bun test / Vitest | `FUSE_SOLID_MAX_LINES` (default 200) |
