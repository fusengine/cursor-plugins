...
name: interface
applies-to: "**/*.go"
description: Interface template - Focused port definition for Go interfaces, copy-paste ready
when-to-use: defining port interfaces, creating contracts, interface design, segregated interfaces
keywords: interface, ports, template, contract, focused methods, Go idiom
---
...
- [ ] Interface methods serve one cohesive client role
...
- [ ] Interface stays within `FUSE_SOLID_MAX_LINES` (default 200) and remains role-focused
