...
applies-to: "**/*.tsx, **/*.jsx"
description: Adapter pattern templates for external integrations using the shared source-size ceiling
---
...
- Keep each adapter within `FUSE_SOLID_MAX_LINES` (default 200) and focused on one integration boundary
