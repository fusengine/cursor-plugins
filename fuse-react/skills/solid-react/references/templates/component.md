...
applies-to: "**/*.tsx, **/*.jsx"
description: React functional component template using the shared source-size ceiling
---
...
- Keep each component within `FUSE_SOLID_MAX_LINES` (default 200) and focused on one UI responsibility
