...
- DRY, KISS, YAGNI
- `FUSE_SOLID_MAX_LINES` (default `200`) is the only file-size ceiling
...
| 3. EXECUTE | Implementation + tests | Files respect `FUSE_SOLID_MAX_LINES` (default `200`), types/interfaces separated, SOLID followed |
