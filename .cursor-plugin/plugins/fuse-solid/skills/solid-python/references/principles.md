...
| **ISP** | Small, focused interfaces | Protocol segregation by client role |
...
- Source files stay within `FUSE_SOLID_MAX_LINES` (default 200) and modules are split by responsibility when cohesion drops
...
Split interfaces that mix client roles into focused Protocols.
