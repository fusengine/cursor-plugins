...
description: createServerFn template - validated server-only RPC using the shared source-size ceiling
---
...
- Keep the server-function file within `FUSE_SOLID_MAX_LINES` (default 200) and focused on one operation.
