...
- `mcp__fuse-browser__browser_fill`
- `mcp__fuse-browser__browser_press`
- `mcp__fuse-browser__browser_click`
- `mcp__fuse-browser__browser_console`
- `mcp__fuse-browser__browser_screenshot`
- `mcp__fuse-browser__browser_probe`
- `mcp__fuse-browser__browser_probe_html`
- `mcp__fuse-browser__browser_network`
- `mcp__fuse-browser__browser_cookies`
- `mcp__fuse-browser__browser_route`
- `mcp__fuse-browser__browser_dialog`
- `mcp__fuse-browser__browser_login`
