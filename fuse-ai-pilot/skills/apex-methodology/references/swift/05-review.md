...
- [ ] Views have a focused presentation responsibility
- [ ] ViewModels have a focused state responsibility
- [ ] Services have a focused business responsibility
- [ ] Distinct view sections are extracted into subviews
...
```bash
jq --arg p "review" '.tasks[.current_task].phase = $p' .cursor/apex/task.json \
