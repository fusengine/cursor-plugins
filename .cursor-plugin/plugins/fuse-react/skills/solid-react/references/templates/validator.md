...
applies-to: "**/*.tsx, **/*.jsx"
description: Zod validation schema templates using the shared source-size ceiling
---
...
- Keep each validator file within `FUSE_SOLID_MAX_LINES` (default 200) and focused on one validation domain
