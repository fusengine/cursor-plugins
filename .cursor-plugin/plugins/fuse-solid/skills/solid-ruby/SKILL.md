...
4. If code is genuinely shared across features -> create it in `app/modules/core/`
...
|-------|----------|----------------|
| Controllers | `app/modules/[feature]/controllers/` | Parse requests and delegate |
| Services | `app/modules/[feature]/services/` | Orchestrate business logic |
| Repositories | `app/modules/[feature]/repositories/` | Encapsulate persistence |
| Contracts | `app/modules/[feature]/contracts/` | Define stable abstractions |
| Models | `app/modules/[feature]/models/` | Represent domain data |
| Shared | `app/modules/core/{services,contracts,concerns}/` | Host cross-feature concerns |
