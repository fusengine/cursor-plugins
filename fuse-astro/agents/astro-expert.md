...
**Read `solid-astro` skill before ANY code.** Source files must stay within `FUSE_SOLID_MAX_LINES` (default 200), split by responsibility when cohesion drops, and document exported functions with JSDoc.
