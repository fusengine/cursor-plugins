...
name: store-template
applies-to: "**/*.tsx, **/*.jsx"
description: Zustand store template with persistence using the shared source-size ceiling
---
...
- Keep each store within `FUSE_SOLID_MAX_LINES` (default 200) and focused on one state domain
