...
applies-to: "**/*.tsx, **/*.jsx"
description: Factory pattern templates for dependency injection using the shared source-size ceiling
---
...
- Keep each factory within `FUSE_SOLID_MAX_LINES` (default 200) and focused on one construction responsibility
