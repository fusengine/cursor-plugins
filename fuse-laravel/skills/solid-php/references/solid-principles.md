...
|-----------|------|-----------|-----|
| **S**RP | 1 class = 1 responsibility | Source file exceeds `FUSE_SOLID_MAX_LINES` (default 200) | Split class |
...
```
Code violates SOLID?
├── Source file exceeds FUSE_SOLID_MAX_LINES → SRP: Split class
