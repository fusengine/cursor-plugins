...
name: error-template
applies-to: "**/*.tsx, **/*.jsx"
description: Custom error class templates using the shared source-size ceiling
---
...
- Keep each error file within `FUSE_SOLID_MAX_LINES` (default 200) and focused on one error family
