...
description: TanStack Start route template - orchestrator only, loader calls server functions, shared source-size ceiling
---
...
- Keep the route within `FUSE_SOLID_MAX_LINES` (default 200) and focused on orchestration.
